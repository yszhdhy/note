...
![img](https://cdn.nlark.com/yuque/0/2023/png/1613913/1679922435118-bde3347e-b9fe-4138-8e16-0c231884ea5f.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_39%2Ctext_5bCa56GF6LC3IGF0Z3VpZ3UuY29t%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
![img](https://cdn.nlark.com/yuque/0/2023/png/1613913/1679970508234-3c6b8ecc-6372-4eb5-8c67-563054d1a72d.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_37%2Ctext_5bCa56GF6LC3IGF0Z3VpZ3UuY29t%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
![image-20230602102923177](./assets/image-20230602102923177.png)
...
![img](https://cdn.nlark.com/yuque/0/2023/png/1613913/1680232037132-d2fa8085-3847-46f2-ac62-14a6188492aa.png?x-oss-process=image%2Fwatermark%2Ctype_d3F5LW1pY3JvaGVp%2Csize_29%2Ctext_5bCa56GF6LC3IGF0Z3VpZ3UuY29t%2Ccolor_FFFFFF%2Cshadow_50%2Ct_80%2Cg_se%2Cx_10%2Cy_10)
...
![image-20230602094708597](./assets/image-20230602094708597.png)
...
![image-20230602095600037](./assets/image-20230602095600037.png)
...
![image-20230602095658405](./assets/image-20230602095658405.png)

![image-20230602095706444](./assets/image-20230602095706444.png)
...
![image-20230602100231786](./assets/image-20230602100231786.png)

1. 1. 最终因为要`json`所以`MappingJackson2HttpMessageConverter`支持写出json
   2. jackson用`ObjectMapper`把对象写出去
...
默认8个：![image-20230602100257461](./assets/image-20230602100257461.png)
...
![image-20230602100521368](./assets/image-20230602100521368.png)
...
1Spring Boot 在类路径根下查找messages资源绑定文件。文件名为：messages.properties

2多语言可以定义多个消息文件，命名为messages_区域代码.properties。如：
...
3在程序中可以自动注入 MessageSource组件，获取国际化的配置项值

4在页面中可以使用表达式  #{}获取国际化的配置项值
...
![image-20230602101652213](./assets/image-20230602101652213.png)
...
![image-20230602101857236](./assets/image-20230602101857236.png)
...
![image-20230602102007504](./assets/image-20230602102007504.png)
...
2推荐网站：[Spring Boot banner 在线生成工具，制作下载英文 banner.txt，修改替换 banner.txt 文字实现自定义，个性化启动 banner-bootschool.net](https://www.bootschool.net/ascii)
...
![image-20230602133429051](./assets/image-20230602133429051.png)
...
![image-20230602133826151](./assets/image-20230602133826151.png)
...
![image-20230602133848082](./assets/image-20230602133848082.png)
...
![image-20230602133922964](./assets/image-20230602133922964.png)

应用事件发送顺序如下：

![image-20230602133933498](./assets/image-20230602133933498.png)
...
![image-20230602134006393](./assets/image-20230602134006393.png)

![image-20230602134012275](./assets/image-20230602134012275.png)
...
![image-20230602134219835](./assets/image-20230602134219835.png)
...
![image-20230602134454232](./assets/image-20230602134454232.png)
...
![image-20230602135436990](./assets/image-20230602135436990.png)
...
![image-20230602135845704](./assets/image-20230602135845704.png)
...
![image-20230602140241442](./assets/image-20230602140241442.png)

#### 2. 解耦

![image-20230602140304465](./assets/image-20230602140304465.png)

#### 3. 削峰

![image-20230602140326603](./assets/image-20230602140326603.png)



#### 4. 缓冲

![image-20230602140343157](./assets/image-20230602140343157.png)

### 消息队列-Kafka

#### 1. 消息模式

![image-20230602140412113](./assets/image-20230602140412113.png)
...
![image-20230602140427605](./assets/image-20230602140427605.png)
...
![image-20230602140850395](./assets/image-20230602140850395.png)

##### 2. FilterChainProxy

![image-20230602140902163](./assets/image-20230602140902163.png)

##### 3. SecurityFilterChain

![image-20230602140917850](./assets/image-20230602140917850.png)
...
![image-20230602141707629](./assets/image-20230602141707629.png)
...
![image-20230602141858484](./assets/image-20230602141858484.png)
...
![image-20230602141959589](./assets/image-20230602141959589.png)
...
![image-20230602142043588](./assets/image-20230602142043588.png)
...
![image-20230602142103257](./assets/image-20230602142103257.png)
...
![image-20230602142211531](./assets/image-20230602142211531.png)
...
![image-20230602142236172](./assets/image-20230602142236172.png)
...
![image-20230602142308195](./assets/image-20230602142308195.png)
...
![image-20230602142425853](./assets/image-20230602142425853.png)

#### 2. 安装

跨平台提供原生镜像原理：

![image-20230602142439024](./assets/image-20230602142439024.png)

##### 1. VisualStudio

https://visualstudio.microsoft.com/zh-hans/free-developer-offers/

![image-20230602142458008](./assets/image-20230602142458008.png)

![image-20230602142504473](./assets/image-20230602142504473.png)

别选中文

![image-20230602142515430](./assets/image-20230602142515430.png)

![image-20230602142522544](./assets/image-20230602142522544.png)
...
![image-20230602142553966](./assets/image-20230602142553966.png)

![image-20230602142558920](./assets/image-20230602142558920.png)

![image-20230602142605036](./assets/image-20230602142605036.png)

![image-20230602142612676](./assets/image-20230602142612676.png)

###### 2. 配置

修改 JAVA_HOME 与 Path，指向新bin路径

![image-20230602142624396](./assets/image-20230602142624396.png)

![image-20230602142630252](./assets/image-20230602142630252.png)

验证JDK环境为GraalVM提供的即可：

![image-20230602142639665](./assets/image-20230602142639665.png)
...
- ![image-20230602142757696](./assets/image-20230602142757696.png)
- 
...
![image-20230602143006861](./assets/image-20230602143006861.png)
...
![image-20230602143031141](./assets/image-20230602143031141.png)
...
![image-20230602143050482](./assets/image-20230602143050482.png)
